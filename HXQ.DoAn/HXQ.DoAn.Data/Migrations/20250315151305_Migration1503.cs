...
{
    /// <inheritdoc />
    public partial class Migration1503 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EcodeUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Seen = table.Column<bool>(type: "bit", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Shipment = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Payment = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AccountId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(270)", maxLength: 270, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AccountId = table.Column<long>(type: "bigint", nullable: true),
                    AttributeProductId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CartItems_AttributeProducts_AttributeProductId",
                        column: x => x.AttributeProductId,
                        principalTable: "AttributeProducts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributeProductId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_AttributeProducts_AttributeProductId",
                        column: x => x.AttributeProductId,
                        principalTable: "AttributeProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_AttributeProductId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_AttributeProductId",
                table: "OrderDetails",
                column: "AttributeProductId");
